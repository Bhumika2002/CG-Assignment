...
char college[100]="BMS Institute of Technology, Bengaluru-560064";
char dept[100]="Department of Computer Science & Engineering";
char heading[100]="Made by                                                                 Guides:";
char row1[100]="Sharanu (1BY18CS148)                                              Prof.Shankar";
char row2[100]="Shreyas N Raj (1BY18CS159)";
char row3[100]="Bhumika D Shetty (1BY18CS193) ";
...
void frontscreen(void)
{
     ...
     glRasterPos2i(170,270);                                                    //displays 3nd row in table
     for(s=0;row3[s]!='\0';s++)
     {
     glColor3f(0.0,0.0,0.0);
     glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,row3[s]);
     }


     glRasterPos2i(155,250);                                                    //displays dashes
     for(s=0;dash[s]!='\0';s++)
     {
     glColor3f(0.0,0.0,0.0);
     glutBitmapCharacter(GLUT_BITMAP_9_BY_15,dash[s]);
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Moving Ship(CGV MINI PROJECT");
	glutSwapBuffers();
